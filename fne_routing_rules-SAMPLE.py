...
RULES = {
    'Master': {
        ...
        'SEND_TGID': True,
        'GROUP_VOICE': [
            {'NAME': 'Talkgroup 1',    'SRC_GROUP': 1,         'SRC_TS': 1,             'ACTIVE': True,
                                       'ROUTABLE': False,      'DST_NET': 'Master',     'AFFILIATED': False,
            ...
            {'NAME': 'Linked System',  'SRC_GROUP': 1,         'SRC_TS': 1,             'ACTIVE': True,
                                       'ROUTABLE': True,       'DST_NET': 'Repeater-1', 'AFFILIATED': False, 
                                       'DST_GROUP': 2,         'DST_TS': 2,             'IGNORED': [],
                                       'TO_TYPE': 'ON',        'TIMEOUT': 2,            'ON': [8,], 'OFF': [9,10]},
            ...
            {'NAME': 'System Wide P25','SRC_GROUP': 65535,     'SRC_TS': 1,             'ACTIVE': True,
                                       'ROUTABLE': False,      'DST_NET': 'Master',     'AFFILIATED': False,
                                       'DST_GROUP': 16777215,  'DST_TS': 1,             'IGNORED': [],
                                       'TO_TYPE': 'NONE',      'TIMEOUT': 2,            'ON': [], 'OFF': []},
            {'NAME': 'System Wide DMR TS1',
                                       'SRC_GROUP': 16777215,  'SRC_TS': 1,             'ACTIVE': True,
                                       'ROUTABLE': False,      'DST_NET': 'Master',     'AFFILIATED': False,
                                       'DST_GROUP': 16777215,  'DST_TS': 1,             'IGNORED': [],
                                       'TO_TYPE': 'NONE',      'TIMEOUT': 2,            'ON': [], 'OFF': []},
            {'NAME': 'System Wide DMR TS2',
                                       'SRC_GROUP': 16777215,  'SRC_TS': 2,             'ACTIVE': True,
                                       'ROUTABLE': False,      'DST_NET': 'Master',     'AFFILIATED': False,
                                       'DST_GROUP': 16777215,  'DST_TS': 2,             'IGNORED': [],
                                       'TO_TYPE': 'NONE',      'TIMEOUT': 2,            'ON': [], 'OFF': []},
        ]
    },
    ...
    'Parrot': {
        ...
        'GROUP_VOICE': [
            {'NAME': 'Parrot',         'SRC_GROUP': 9990,      'SRC_TS': 1,             'ACTIVE': True,
                                       'ROUTABLE': True,       'DST_NET': 'Master',     'AFFILIATED': False,
