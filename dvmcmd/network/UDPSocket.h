...
namespace network {
    ...
    class HOST_SW_API CUDPSocket {
    public:
        /// <summary>Initializes a new instance of the CUDPSocket class.</summary>
        CUDPSocket(const std::string& address, uint32_t port = 0U);
        /// <summary>Initializes a new instance of the CUDPSocket class.</summary>
        CUDPSocket(uint32_t port = 0U);
        /// <summary>Finalizes a instance of the CUDPSocket class.</summary>
        ~CUDPSocket();
